...
public class SettingsActivity extends BaseActivity {
	...
	public void initViews() {
		super.setupActionBar(getText(R.string.settings_title).toString(), 1, R.drawable.ic_back_arrow_white, -1, -1, -1);
	...
	public void onClick(View v) {
		...
		case R.id.rl_settings_set_bd_pwd:
			...
			.putExtra(LockPatternActivity.START_FROM, LockPatternActivity.START_FROM_SETINGS));
			break;
